...
@section('content')
<div class="flex flex-col items-center justify-center px-6 pt-32 pb-8 mx-auto lg:py-0">
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5" placeholder="name@example.com" value="{{ old('email') }}" required>
                    @error('email')
                ...
                <button type="submit" class="w-full text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
